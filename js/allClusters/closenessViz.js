...
// these are just some preliminary settings
    var attribute;
var inicializarCloseness=function(jsonUrl, C, attr) {
    ...
    var parser= sigma.parsers.json(
        ...
        function () {
            ...
            for (i = 0; i < len; i++) {
                ...
                nodes[i].size = Math.round(parseFloat(nodes[i]["closeness"])*10);
            ...
            function applyMinDegreeFilter(e) {
                ...
                filter
                    ...
                    .nodesBy(
                    function(n, options) {
                        return n.size >= options.minDegreeVal;
                    },
                    {
                        minDegreeVal: +v
                    },
...
function updatePane (graph, filter) {
    ...
    graph.nodes().forEach(function(n) {
        maxDegree = Math.max(maxDegree, n.size);
